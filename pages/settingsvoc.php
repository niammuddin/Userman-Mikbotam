				...
				<div class="card bd-primary">
					...
					<div class="card-body pd-sm-15">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									...
									<input type="text" class="form-control  boxsadaw" name="markup_0" value="<?php if (!empty($datajson[0]['markup'])) {
																													echo $datajson[0]['markup'];
																												} else {
																													echo '0';
																												}
																												?>" onkeypress="return isNumber(event)">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_download_1" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[0]['limit_download'])) {
																																	echo $datajson[0]['limit_total'];
																																} else {
																																	echo '0';
																																} ?>">
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_upload_1" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[0]['limit_upload'])) {
																																	echo $datajson[0]['limit_upload'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_total_1" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[0]['limit_total'])) {
																																echo $datajson[0]['limit_total'];
																															} else {
																																echo '0';
																															} ?>">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<input type="text" class="form-control  boxsadaw" name="prefix_1" value="<?= $datajson[0]['prefix']; ?>">
							</div>
						</div>
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								...
								<input id="colorful1" class="form-control  boxsadaw" name="length_1" type="number" min="1" max="10" value="<?php if (!empty($datajson[0]['length'])) {
																																				echo $datajson[0]['length'];
																																			} else {
																																				echo '1';
																																			} ?>" onkeypress="return isNumber(event)" />
							</div>
				...
				<div class="card bd-primary">
					...
					<div class="card-body pd-sm-15">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									...
									<input type="text" class="form-control  boxsadaw" name="markup_1" value="<?php if (!empty($datajson[1]['markup'])) {
																													echo $datajson[1]['markup'];
																												} else {
																													echo '0';
																												}
																												?>" onkeypress="return isNumber(event)">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_download_2" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[1]['limit_download'])) {
																																	echo $datajson[1]['limit_total'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_upload_2" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[1]['limit_upload'])) {
																																	echo $datajson[1]['limit_upload'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_total_2" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[1]['limit_total'])) {
																																echo $datajson[1]['limit_total'];
																															} else {
																																echo '0';
																															} ?>">
						...
						<div class="row mg-t-8">
							<label class="col-sm-4 form-control-label">Prefix</label>
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<input type="text" class="form-control  boxsadaw" name="prefix_2" value="<?= $datajson[1]['prefix']; ?>">
							</div>
						</div>
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								...
								<input id="colorful2" class="form-control  boxsadaw" name="length_2" type="number" min="1" max="10" value="<?php if (!empty($datajson[1]['length'])) {
																																				echo $datajson[1]['length'];
																																			} else {
																																				echo '1';
																																			}
																																			?>" onkeypress="return isNumber(event)" />
				...
				<div class="card bd-primary">
					...
					<div class="card-body pd-sm-15">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									...
									<input type="text" class="form-control  boxsadaw" name="markup_2" value="<?php if (!empty($datajson[2]['markup'])) {
																													echo $datajson[2]['markup'];
																												} else {
																													echo '0';
																												}
																												?>" onkeypress="return isNumber(event)">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_download_3" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[2]['limit_download'])) {
																																	echo $datajson[2]['limit_total'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_upload_3" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[2]['limit_upload'])) {
																																	echo $datajson[2]['limit_upload'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_total_3" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[2]['limit_total'])) {
																																echo $datajson[2]['limit_total'];
																															} else {
																																echo '0';
																															} ?>">
						...
						<div class="row mg-t-8">
							<label class="col-sm-4 form-control-label">Prefix</label>
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<input type="text" class="form-control  boxsadaw" name="prefix_3" value="<?= $datajson[2]['prefix']; ?>">
							</div>
						</div>
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								...
								<input id="colorful3" class="form-control  boxsadaw" name="length_3" type="number" min="1" max="10" value="<?php if (!empty($datajson[2]['length'])) {
																																				echo $datajson[2]['length'];
																																			} else {
																																				echo '1';
																																			}
																																			?>" onkeypress="return isNumber(event)" />
				...
				<div class="card bd-primary">
					...
					<div class="card-body pd-sm-15">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									...
									<input type="text" class="form-control  boxsadaw" name="markup_3" value="<?php if (!empty($datajson[3]['markup'])) {
																													echo $datajson[3]['markup'];
																												} else {
																													echo '0';
																												}
																												?>" onkeypress="return isNumber(event)">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_download_4" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[3]['limit_download'])) {
																																	echo $datajson[3]['limit_total'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_upload_4" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[3]['limit_upload'])) {
																																	echo $datajson[3]['limit_upload'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_total_4" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[3]['limit_total'])) {
																																echo $datajson[3]['limit_total'];
																															} else {
																																echo '0';
																															} ?>">
						...
						<div class="row mg-t-8">
							<label class="col-sm-4 form-control-label">Prefix</label>
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<input type="text" class="form-control  boxsadaw" name="prefix_4" value="<?= $datajson[3]['prefix']; ?>">
							</div>
						</div>
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								...
								<input id="colorful4" class="form-control  boxsadaw" name="length_4" type="number" min="1" max="10" value="<?php if (!empty($datajson[3]['length'])) {
																																				echo $datajson[3]['length'];
																																			} else {
																																				echo '1';
																																			}
																																			?>" onkeypress="return isNumber(event)" />
				...
				<div class="card bd-primary">
					...
					<div class="card-body pd-sm-15">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									...
									<input type="text" class="form-control  boxsadaw" name="markup_4" value="<?php if (!empty($datajson[4]['markup'])) {
																													echo $datajson[4]['markup'];
																												} else {
																													echo '0';
																												}
																												?>" onkeypress="return isNumber(event)">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_download_5" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[4]['limit_download'])) {
																																	echo $datajson[4]['limit_total'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_upload_5" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[4]['limit_upload'])) {
																																	echo $datajson[4]['limit_upload'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_total_5" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[4]['limit_total'])) {
																																echo $datajson[4]['limit_total'];
																															} else {
																																echo '0';
																															} ?>">
						...
						<div class="row mg-t-10 mg-b-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<select class="form-control select2id" name="typechar_4" data-placeholder="Select Type">
									< <?= show_string($datajson[4]['typechar']) ?> <option value="1">1234</option>
										<option value="2">ABCDE</option>
										<option value="3">abcd</option>
										<option value="4">ABCDabcd</option>
										<option value="5">AbcdABCD1234</option>
						...
						<div class="row mg-t-8">
							<label class="col-sm-4 form-control-label">Prefix</label>
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<input type="text" class="form-control  boxsadaw" name="prefix_5" value="<?= $datajson[4]['prefix']; ?>">
							</div>
						</div>
						...
						<div class="row mg-t-8">
							<label class="col-sm-4 form-control-label">Length Character </label>
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<input id="colorful5" class="form-control  boxsadaw" name="length_5" type="number" min="0" max="10" value="<?php if (!empty($datajson[4]['length'])) {
																																				echo $datajson[4]['length'];
																																			} else {
																																				echo '1';
																																			}
																																			?>" onkeypress="return isNumber(event)" />
				...
				<div class="card bd-primary">
					...
					<div class="card-body pd-sm-15">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									...
									<input type="text" class="form-control  boxsadaw" name="markup_5" value="<?php if (!empty($datajson[5]['markup'])) {
																													echo $datajson[5]['markup'];
																												} else {
																													echo '0';
																												}
																												?>" onkeypress="return isNumber(event)">
						...
						<div class="row mg-t-8">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_download_6" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[5]['limit_download'])) {
																																	echo $datajson[5]['limit_total'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_upload_6" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[5]['limit_upload'])) {
																																	echo $datajson[5]['limit_upload'];
																																} else {
																																	echo '0';
																																} ?>">
									<span class="input-group-addon">Mbps</span>
						...
						<div class="row mg-t-10">
							...
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<div class="input-group">
									<input type="number" name="limit_total_6" class="form-control  boxsadaw" min="0" value="<?php if (!empty($datajson[5]['limit_total'])) {
																																echo $datajson[5]['limit_total'];
																															} else {
																																echo '0';
																															} ?>">
						...
						<div class="row mg-t-8">
							<label class="col-sm-4 form-control-label">Prefix</label>
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<input type="text" class="form-control  boxsadaw" name="prefix_6" value="<?= $datajson[5]['prefix']; ?>">
							</div>
						</div>
						...
						<div class="row mg-t-8">
							<label class="col-sm-4 form-control-label">Length Character </label>
							<div class="col-sm-8 mg-t-10 mg-sm-t-0">
								<input id="colorful6" class="form-control  boxsadaw" name="length_6" type="number" min="0" max="10" value="<?php if (!empty($datajson[5]['length'])) {
																																				echo $datajson[5]['length'];
																																			} else {
																																				echo '1';
																																			}
																																			?>" onkeypress="return isNumber(event)" />
