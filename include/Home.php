...
<body <?= $hideBodyHotspot . $hideBodyPPP; ?>>
  <div id="mikbotam" class="sl-logo bg-primary tx-white">RADIUS</div>
      ...
      <nav class="nav">
        <div class="dropdown">
          <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
            <!--<span class="logged-name">Administrator</span>-->
            <img src="/img/newuser.svg" class="wd-36 rounded-circle" alt="">
          </a>
